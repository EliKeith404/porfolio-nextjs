...
const Main = ({ content }) => {
	...
	return (
		<section id="home" className="w-full h-screen text-center min-h-[600px]">
			<div className="max-w-7xl w-full h-full mx-auto p-2 flex justify-center items-center flex-col">
				<main>
					<p className="uppercase text-sm tracking-widest ">Let&apos;s build something amazing</p>
