			...
			<div className="max-w-[1240px] px-2 py-16 m-auto md:grid grid-cols-3 gap-8">
				<div className="col-span-2">
					...
					<p className="py-2 text-gray-600">
						...
						thinking of the most efficient solution to a challenge. I began
						programming in elementary school building 2D game applications using
						drag-and-drop softwares, and soon after began tinkering with any
						electronic device I could find. I began my professional career at an
						...
						the game masters to maintain.
					</p>
					<p className="py-2 text-gray-600">
						I&apos;ve since realized how vast the world of programming is, and
						took up web development. The more websites I made, the more I wanted
						to take that to the next level. I&apos;ve most recently assisted in
