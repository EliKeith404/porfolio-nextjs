...
const Skills = ({ skills }) => {
	return (
		<section id="skills" className="w-full px-2 py-10 flex items-center justify-center">
			<div className="w-full max-w-7xl px-2 py-16 flex flex-col justify-center">
				<span className="text-xl tracking-widest uppercase text--purple">Skills</span>
