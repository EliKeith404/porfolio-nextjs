...
const Navbar = () => {
	...
	return (
		<div
			className={`${window.scrollY >= 90 ? 'shadow-xl' : ''} nav flex justify-center 
			`}
		>
			{/* Desktop Nav */}
			<header className="flex justify-between items-center w-full h-full px-2 max-w-7xl">
				<div className="px-5">
					<Link href="/">
						<a>
				...
				<nav className="flex items-center h-full min-h-full">
					<ul className="hidden md:flex h-full">
						...
						<li className="group h-full flex items-center" onClick={() => handleChangeTheme()}>
				...
				>
					...
					<nav>
						<ul className="uppercase">
							...
							<NavbarItem href="/#projects" isMobile={true} callback={handleNav}>
								Projects
							</NavbarItem>
						...
						<div className="pt-[5rem]">
							<p className="uppercase tracking-widest text-center text--purple">Connect With Me</p>
